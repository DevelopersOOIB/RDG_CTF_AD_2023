...
if [[ ${NAMED_GID_ACTUAL} -ne ${NAMED_GID} || ${NAMED_UID_ACTUAL} -ne ${NAMED_UID} ]]
then
...
chmod -R o-rwx /etc/bind /var/bind /etc/bind /var/run/named /var/log/named
echo "[DONE]"
